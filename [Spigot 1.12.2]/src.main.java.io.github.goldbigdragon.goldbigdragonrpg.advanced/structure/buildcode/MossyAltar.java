...
public class MossyAltar {
	...
	private String mossyStoneSuffix = "\",ShowArms:1,Invisible:1,NoBasePlate:1,NoGravity:1,HandItems:[{id:mossy_cobblestone,Count:1},{}],Pose:{Body:[0f,0f,0f],LeftArm:[0f,0f,0f],RightArm:[346f,44f,270f],LeftLeg:[0f,0f,0f],RightLeg:[0f,0f,0f],Head:[0f,0f,0f]}}";
	...
	public String createMossyAltar(int lineNumber, String structureCode)
	{
		...
		{
			if(lineNumber<=4)
				sb.append("~-0.18 ~"+(0.652+(lineNumber*0.34))+" ~-0.28 {CustomName:\"" + structureCode);
		...
		switch(lineNumber)
		{
		case 20: sb.append("~-0.52 ~2.012 ~-0.28 {CustomName:\"" + structureCode); break;
