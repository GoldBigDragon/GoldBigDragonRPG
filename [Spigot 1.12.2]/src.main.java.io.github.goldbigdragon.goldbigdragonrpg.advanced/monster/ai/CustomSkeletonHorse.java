...
public class CustomSkeletonHorse extends EntityMonster
{
	public CustomSkeletonHorse(World world, int AI)
	{
		super(world);
	    try
	    {
	...
	public static Object spawn(Location location, int AI)
	{
		...
		final CustomSkeletonHorse customEntity = new CustomSkeletonHorse(mcWorld, AI);
