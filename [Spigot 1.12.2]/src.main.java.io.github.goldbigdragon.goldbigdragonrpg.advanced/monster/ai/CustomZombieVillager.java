...
public class CustomZombieVillager extends EntityZombieVillager
{
	public CustomZombieVillager(World world, int AI)
	{
		super(world);
	    try
	    {
	...
	public static Object spawn(Location location, int AI)
	{
		...
		final CustomZombieVillager customEntity = new CustomZombieVillager(mcWorld, AI);
