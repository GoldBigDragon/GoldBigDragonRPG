...
public class CustomIronGolem extends EntityMonster
{
	public CustomIronGolem(World world, int AI)
	{
		super(world);
	    try
	    {
	...
	public static Object spawn(Location location, int AI)
	{
		...
		final CustomIronGolem customEntity = new CustomIronGolem(mcWorld, AI);
