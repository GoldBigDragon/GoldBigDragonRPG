...
public class CustomVillager extends EntityMonster
{
	public CustomVillager(World world, int AI)
	{
		super(world);
	    try
	    {
	...
	public static Object spawn(Location location, int AI)
	{
		...
		final CustomVillager customEntity = new CustomVillager(mcWorld, AI);
