...
public class CustomMooshroom extends EntityMonster
{
	public CustomMooshroom(World world, int AI)
	{
		super(world);
	    try
	    {
	...
	public static Object spawn(Location location, int AI)
	{
		...
		final CustomMooshroom customEntity = new CustomMooshroom(mcWorld, AI);
