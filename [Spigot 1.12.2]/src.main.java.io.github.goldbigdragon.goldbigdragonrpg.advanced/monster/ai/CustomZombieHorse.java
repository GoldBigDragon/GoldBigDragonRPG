...
public class CustomZombieHorse extends EntityMonster
{
	public CustomZombieHorse(World world, int AI)
	{
		super(world);
	    try
	    {
	...
	public static Object spawn(Location location, int AI)
	{
		...
		final CustomZombieHorse customEntity = new CustomZombieHorse(mcWorld, AI);
