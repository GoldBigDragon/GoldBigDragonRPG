...
import GoldBigDragon_RPG.Custom.AI_Animal;
import GoldBigDragon_RPG.Custom.AI_CombatMonster;
import GoldBigDragon_RPG.Custom.AI_Elite_Hunter;
import GoldBigDragon_RPG.Custom.AI_Hunter;
import GoldBigDragon_RPG.Custom.AI_KamiKaze;
import GoldBigDragon_RPG.Custom.AI_NoBrain;
import GoldBigDragon_RPG.Custom.AI_Spector;
import GoldBigDragon_RPG.Custom.NMSUtils;
...
public class Monster
{
	...
	public void SpawnMob(Location loc, String mob)
	{
		...
		{
			GoldBigDragon_RPG.Main.Main.spawntime=false;
			loc.add(0.5, 1, 0.5);
			YamlManager Monster  = Monster_YC.getNewConfig("Monster/MonsterList.yml");
			...
			GoldBigDragon_RPG.Main.Main.spawntime=true;
		}
		return;
	}
