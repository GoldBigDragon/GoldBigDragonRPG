...
public class OPBoxSkillGUI extends GUIutil
{
	...
	public void IndividualSkillOptionGUI(Player player, int page, String SkillName)
	{
		...
		for(int count = page*45; count < b.size();count++)
		{
			...
			if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusSTR")<0)
				lore = lore + ChatColor.RED+"승급시 보너스 "+GoldBigDragon_RPG.Main.ServerOption.STR+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusSTR")+"%enter%";
			else if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusSTR")>0)
				lore = lore + ChatColor.AQUA+"승급시 보너스 "+GoldBigDragon_RPG.Main.ServerOption.STR+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusSTR")+"%enter%";

			if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusDEX")<0)
				lore = lore + ChatColor.RED+"승급시 보너스 "+GoldBigDragon_RPG.Main.ServerOption.DEX+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusDEX")+"%enter%";
			else if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusDEX")>0)
				lore = lore + ChatColor.AQUA+"승급시 보너스 "+GoldBigDragon_RPG.Main.ServerOption.DEX+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusDEX")+"%enter%";
				
			if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusINT")<0)
				lore = lore + ChatColor.RED+"승급시 보너스 "+GoldBigDragon_RPG.Main.ServerOption.INT+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusINT")+"%enter%";
			else if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusINT")>0)
				lore = lore + ChatColor.AQUA+"승급시 보너스 "+GoldBigDragon_RPG.Main.ServerOption.INT+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusINT")+"%enter%";

			if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusWILL")<0)
				lore = lore + ChatColor.RED+"승급시 보너스 "+GoldBigDragon_RPG.Main.ServerOption.WILL+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusWILL")+"%enter%";
			else if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusWILL")>0)
				lore = lore + ChatColor.AQUA+"승급시 보너스 "+GoldBigDragon_RPG.Main.ServerOption.WILL+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusWILL")+"%enter%";

			if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusLUK")<0)
				lore = lore + ChatColor.RED+"승급시 보너스 "+GoldBigDragon_RPG.Main.ServerOption.LUK+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusLUK")+"%enter%";
			else if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusLUK")>0)
				lore = lore + ChatColor.AQUA+"승급시 보너스 "+GoldBigDragon_RPG.Main.ServerOption.LUK+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusLUK")+"%enter%";
		...
		if(SkillList.getString(SkillName+".SkillRank."+SkillLevel+".Command").equalsIgnoreCase("null"))
			...
			if(Bukkit.getPluginManager().isPluginEnabled("MagicSpells") == true)
			{
				...
				if(IncreaseDamage.compareTo("없음")==0)
					...
					Stack2(ChatColor.WHITE+""+ChatColor.BOLD + "[스킬 공격력 상승]", 267,0,1,Arrays.asList("",ChatColor.WHITE+"[  "+IncreaseDamage+"  ]",ChatColor.RED + "["+GoldBigDragon_RPG.Main.ServerOption.STR+"에 비례하여 대미지 상승]","",ChatColor.YELLOW + "[좌 클릭시 영향 주는 스텟 변경]"), 21, inv);
				else if(IncreaseDamage.compareTo(GoldBigDragon_RPG.Main.ServerOption.DEX)==0)
					Stack2(ChatColor.WHITE+""+ChatColor.BOLD + "[스킬 공격력 상승]", 261,0,1,Arrays.asList("",ChatColor.WHITE+"[  "+IncreaseDamage+"  ]",ChatColor.RED + "["+GoldBigDragon_RPG.Main.ServerOption.DEX+"에 비례하여 대미지 상승]","",ChatColor.YELLOW + "[좌 클릭시 영향 주는 스텟 변경]"), 21, inv);
				else if(IncreaseDamage.compareTo(GoldBigDragon_RPG.Main.ServerOption.INT)==0)
					Stack2(ChatColor.WHITE+""+ChatColor.BOLD + "[스킬 공격력 상승]", 369,0,1,Arrays.asList("",ChatColor.WHITE+"[  "+IncreaseDamage+"  ]",ChatColor.RED + "["+GoldBigDragon_RPG.Main.ServerOption.INT+"에 비례하여 대미지 상승]","",ChatColor.YELLOW + "[좌 클릭시 영향 주는 스텟 변경]"), 21, inv);
				else if(IncreaseDamage.compareTo(GoldBigDragon_RPG.Main.ServerOption.WILL)==0)
					Stack2(ChatColor.WHITE+""+ChatColor.BOLD + "[스킬 공격력 상승]", 370,0,1,Arrays.asList("",ChatColor.WHITE+"[  "+IncreaseDamage+"  ]",ChatColor.RED + "["+GoldBigDragon_RPG.Main.ServerOption.WILL+"에 비례하여 대미지 상승]","",ChatColor.YELLOW + "[좌 클릭시 영향 주는 스텟 변경]"), 21, inv);
				else if(IncreaseDamage.compareTo(GoldBigDragon_RPG.Main.ServerOption.LUK)==0)
					Stack2(ChatColor.WHITE+""+ChatColor.BOLD + "[스킬 공격력 상승]", 322,0,1,Arrays.asList("",ChatColor.WHITE+"[  "+IncreaseDamage+"  ]",ChatColor.RED + "["+GoldBigDragon_RPG.Main.ServerOption.LUK+"에 비례하여 대미지 상승]","",ChatColor.YELLOW + "[좌 클릭시 영향 주는 스텟 변경]"), 21, inv);
				else
			...
			if(SkillLevel != 1)
			{
				...
				Stack2(ChatColor.WHITE+""+ChatColor.BOLD + "[보너스 "+GoldBigDragon_RPG.Main.ServerOption.STR+"]", 267,0,1,Arrays.asList("",ChatColor.AQUA + "["+SkillName+" "+(SkillLevel-1)+" 레벨에서",ChatColor.AQUA +"현재 레벨로 승급할 때 얻는 "+GoldBigDragon_RPG.Main.ServerOption.STR+"]",ChatColor.WHITE +"     "+ChatColor.BOLD+SkillList.getInt(SkillName+".SkillRank."+SkillLevel+".BonusSTR"),"",ChatColor.YELLOW + "[좌 클릭시 보너스 스텟 변경]"), 30, inv);
				Stack2(ChatColor.WHITE+""+ChatColor.BOLD + "[보너스 "+GoldBigDragon_RPG.Main.ServerOption.DEX+"]", 261,0,1,Arrays.asList("",ChatColor.AQUA + "["+SkillName+" "+(SkillLevel-1)+" 레벨에서",ChatColor.AQUA +"현재 레벨로 승급할 때 얻는 "+GoldBigDragon_RPG.Main.ServerOption.DEX+"]",ChatColor.WHITE +"     "+ChatColor.BOLD+SkillList.getInt(SkillName+".SkillRank."+SkillLevel+".BonusDEX") ,"",ChatColor.YELLOW + "[좌 클릭시 보너스 스텟 변경]"), 31, inv);
				Stack2(ChatColor.WHITE+""+ChatColor.BOLD + "[보너스 "+GoldBigDragon_RPG.Main.ServerOption.INT+"]", 369,0,1,Arrays.asList("",ChatColor.AQUA + "["+SkillName+" "+(SkillLevel-1)+" 레벨에서",ChatColor.AQUA +"현재 레벨로 승급할 때 얻는 "+GoldBigDragon_RPG.Main.ServerOption.INT+"]",ChatColor.WHITE +"     "+ChatColor.BOLD+SkillList.getInt(SkillName+".SkillRank."+SkillLevel+".BonusINT"),"",ChatColor.YELLOW + "[좌 클릭시 보너스 스텟 변경]"), 32, inv);
				Stack2(ChatColor.WHITE+""+ChatColor.BOLD + "[보너스 "+GoldBigDragon_RPG.Main.ServerOption.WILL+"]", 370,0,1,Arrays.asList("",ChatColor.AQUA + "["+SkillName+" "+(SkillLevel-1)+" 레벨에서",ChatColor.AQUA +"현재 레벨로 승급할 때 얻는 "+GoldBigDragon_RPG.Main.ServerOption.WILL+"]",ChatColor.WHITE +"     "+ChatColor.BOLD+SkillList.getInt(SkillName+".SkillRank."+SkillLevel+".BonusWILL") ,"",ChatColor.YELLOW + "[좌 클릭시 보너스 스텟 변경]"), 33, inv);
				Stack2(ChatColor.WHITE+""+ChatColor.BOLD + "[보너스 "+GoldBigDragon_RPG.Main.ServerOption.LUK+"]", 322,0,1,Arrays.asList("",ChatColor.AQUA + "["+SkillName+" "+(SkillLevel-1)+" 레벨에서",ChatColor.AQUA +"현재 레벨로 승급할 때 얻는 "+GoldBigDragon_RPG.Main.ServerOption.LUK+"]",ChatColor.WHITE +"     "+ChatColor.BOLD+SkillList.getInt(SkillName+".SkillRank."+SkillLevel+".BonusLUK") ,"",ChatColor.YELLOW + "[좌 클릭시 보너스 스텟 변경]"), 34, inv);
	...
	public void SkillRankOptionGUIClick(InventoryClickEvent event)
	{
		...
		case 29://보너스 마나
			...
			break;
		case 30://보너스 "+GoldBigDragon_RPG.Main.ServerOption.STR+"
			player.sendMessage(ChatColor.LIGHT_PURPLE+"[스킬] : 보너스 "+GoldBigDragon_RPG.Main.ServerOption.STR+" 수치를 입력해 주세요!");
			u.setType(player, "Skill");
			u.setString(player, (byte)1, "BSTR");
			break;
		case 31://보너스 "+GoldBigDragon_RPG.Main.ServerOption.DEX+"
			player.sendMessage(ChatColor.LIGHT_PURPLE+"[스킬] : 보너스 "+GoldBigDragon_RPG.Main.ServerOption.DEX+" 수치를 입력해 주세요!");
			u.setType(player, "Skill");
			u.setString(player, (byte)1, "BDEX");
			break;
		case 32://보너스 "+GoldBigDragon_RPG.Main.ServerOption.INT+"
			player.sendMessage(ChatColor.LIGHT_PURPLE+"[스킬] : 보너스 "+GoldBigDragon_RPG.Main.ServerOption.INT+" 수치를 입력해 주세요!");
			u.setType(player, "Skill");
			u.setString(player, (byte)1, "BINT");
			break;
		case 33://보너스 "+GoldBigDragon_RPG.Main.ServerOption.WILL+"
			player.sendMessage(ChatColor.LIGHT_PURPLE+"[스킬] : 보너스 "+GoldBigDragon_RPG.Main.ServerOption.WILL+" 수치를 입력해 주세요!");
			u.setType(player, "Skill");
			u.setString(player, (byte)1, "BWILL");
			break;
		case 34://보너스 "+GoldBigDragon_RPG.Main.ServerOption.LUK+"
			player.sendMessage(ChatColor.LIGHT_PURPLE+"[스킬] : 보너스 "+GoldBigDragon_RPG.Main.ServerOption.LUK+" 수치를 입력해 주세요!");
			u.setType(player, "Skill");
