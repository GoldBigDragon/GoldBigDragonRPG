...
public class PlayerSkillGUI extends GUIutil
{
	public void MainSkillsListGUI(Player player, int page)
	{
		...
		YamlManager PlayerSkillList  = YC_2.getNewConfig("Skill/PlayerData/"+player.getUniqueId().toString()+".yml");
		Inventory inv = null;
	...
	public void SkillListGUI(Player player, int page,boolean isMabinogi, String CategoriName)
	{
		...
		YamlManager Config = YC_2.getNewConfig("config.yml");
		YamlManager PlayerSkillList  = YC_2.getNewConfig("Skill/PlayerData/"+player.getUniqueId().toString()+".yml");
		YamlManager AllSkillList  = YC_2.getNewConfig("Skill/SkillList.yml");
		YamlManager PlayerStats  = YC_2.getNewConfig("Stats/"+player.getUniqueId().toString()+".yml");
		Inventory inv = null;
