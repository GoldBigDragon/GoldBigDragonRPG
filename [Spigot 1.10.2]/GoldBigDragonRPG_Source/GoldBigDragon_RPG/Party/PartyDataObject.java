...
public class PartyDataObject
{
						...
						for(byte count = 0; count < this.PartyCapacity; count++)
							if(this.PartyMember[count] == null)
							{
								if(player.isOnline())
								{
									...
									new GoldBigDragon_RPG.Effect.Sound().SP(player, Sound.BLOCK_WOODEN_DOOR_OPEN, 1.1F, 1.0F);
								}
	...
	public void QuitParty(Player player)
	{
		...
		if(player.isOnline())
		{
			...
			new GoldBigDragon_RPG.Effect.Sound().SP(player, Sound.BLOCK_WOODEN_DOOR_CLOSE, 1.1F, 1.0F);
		}
