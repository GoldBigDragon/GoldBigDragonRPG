	...
	public void EntityInteract(PlayerInteractEntityEvent event, String Type)
	{
    	...
    	if(Type.compareTo("Quest")==0)
    	{
    				...
    				&&u.getString(player,(byte)3)!=null)
    		{
    			...
    			new GoldBigDragon_RPG.Effect.Sound().SP(event.getPlayer(), org.bukkit.Sound.ENTITY_HORSE_ARMOR, 1.0F,1.2F);
        	...
        	switch(u.getString(player,(byte)1))
        	{
	        	case "Script" :
	        	{
	        		...
	        		if(u.getString(player,(byte)3)!=null)
	        		{
	    				...
	    				new GoldBigDragon_RPG.Effect.Sound().SP(event.getPlayer(), org.bukkit.Sound.ENTITY_ITEM_PICKUP, 0.5F,1.2F);
