    ...
    public void CheckConfig()
	{
    	...
    	if(configYaml.contains("Version")==false)
    	{
			...
			configYaml.set("Server.AntiExplode", true);
		  	...
		  	configYaml.set("Normal_Monster.NETHER_SKELETON.EXP", 20);
		  	configYaml.set("Normal_Monster.NETHER_SKELETON.MIN_MONEY", 40);
		  	configYaml.set("Normal_Monster.NETHER_SKELETON.MAX_MONEY", 80);
		...
		if(configYaml.contains("Server.DEX_Lore"))
			main.Main_ServerOption.DEX_Lore = configYaml.getString("Server.DEX_Lore");
		if(configYaml.contains("Server.INT_Lore"))
			main.Main_ServerOption.INT_Lore = configYaml.getString("Server.INT_Lore");
		if(configYaml.contains("Server.WILL_Lore"))
			main.Main_ServerOption.WILL_Lore = configYaml.getString("Server.WILL_Lore");
		if(configYaml.contains("Server.LUK_Lore"))
			main.Main_ServerOption.LUK_Lore = configYaml.getString("Server.LUK_Lore");
		if(configYaml.contains("Server.Money.1.ID"))
			main.Main_ServerOption.Money1ID = (short) configYaml.getInt("Server.Money.1.ID");
		if(configYaml.contains("Server.Money.2.ID"))
			main.Main_ServerOption.Money2ID = (short) configYaml.getInt("Server.Money.2.ID");
		if(configYaml.contains("Server.Money.3.ID"))
			main.Main_ServerOption.Money3ID = (short) configYaml.getInt("Server.Money.3.ID");
		if(configYaml.contains("Server.Money.4.ID"))
			main.Main_ServerOption.Money4ID = (short) configYaml.getInt("Server.Money.4.ID");
		if(configYaml.contains("Server.Money.5.ID"))
			main.Main_ServerOption.Money5ID = (short) configYaml.getInt("Server.Money.5.ID");
		if(configYaml.contains("Server.Money.6.ID"))
			main.Main_ServerOption.Money6ID = (short) configYaml.getInt("Server.Money.6.ID");
		if(configYaml.contains("Server.Money.1.DATA"))
			main.Main_ServerOption.Money1DATA = (byte) configYaml.getInt("Server.Money.1.DATA");
		if(configYaml.contains("Server.Money.2.DATA"))
			main.Main_ServerOption.Money2DATA = (byte) configYaml.getInt("Server.Money.2.DATA");
		if(configYaml.contains("Server.Money.3.DATA"))
			main.Main_ServerOption.Money3DATA = (byte) configYaml.getInt("Server.Money.3.DATA");
		if(configYaml.contains("Server.Money.4.DATA"))
			main.Main_ServerOption.Money4DATA = (byte) configYaml.getInt("Server.Money.4.DATA");
		if(configYaml.contains("Server.Money.5.DATA"))
			main.Main_ServerOption.Money5DATA = (byte) configYaml.getInt("Server.Money.5.DATA");
		...
		if(configYaml.contains("Death.ReviveItem"))
			main.Main_ServerOption.DeathRevive = configYaml.getItemStack("Death.ReviveItem");
		if(configYaml.contains("Death.RescueItem"))
			main.Main_ServerOption.DeathRescue = configYaml.getItemStack("Death.RescueItem");
