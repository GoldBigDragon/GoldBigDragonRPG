...
public class YamlLoader
{
	...
	public void getConfig(String path, String encoding)
	{
		...
		config = YamlConfiguration.loadConfiguration(getStream());
	}
	...
	public InputStream getStream()
	{
		try
		{
			...
			BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(file), defaultCharset));

			while ((currentLine = reader.readLine()) != null)
				whole.append(currentLine + "\n");

			InputStream configStream = new ByteArrayInputStream(whole.toString().getBytes(defaultCharset));
			reader.close();
			return configStream;
		}
		catch (IOException e)
