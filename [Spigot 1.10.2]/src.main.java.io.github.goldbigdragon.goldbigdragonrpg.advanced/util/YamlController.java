...
public class YamlLoader 
{
 ...
 public getNewConfig(String fileName, String[] header) 
 {
  ...
  config = new YamlManager(this.getConfigContent(fileName), file, this.getCommentsNum(file), plugin);
  return config;
 }
 ...
 public getNewConfig(String fileName) 
 {
