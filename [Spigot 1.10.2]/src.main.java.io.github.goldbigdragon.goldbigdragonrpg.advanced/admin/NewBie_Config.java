...
public class NewBie_Config
{
    public void createNewConfig()
	{
		...
		icon.setItemMeta(iconMeta);
	  	...
	  	iconMeta.setLore(Arrays.asList("§7플러그인에는 5가지 스텟이 있습니다.","§c["+main.Main_ServerOption.statSTR+"]","§7"+main.Main_ServerOption.statSTR+"은 플레이어의","§7물리적 데미지에 관여합니다.",ChatColor.GREEN + "["+main.Main_ServerOption.statDEX+"]","§7"+main.Main_ServerOption.statDEX+"는 플레이어의 밸런스 및","§7생산 성공률과 생산 품질,","§7원거리 데미지에 관여합니다.","§9["+main.Main_ServerOption.statINT+"]","§7"+main.Main_ServerOption.statINT+"은 마법방어 및 마법보호,","§7마법 공격력에 관여합니다.","§f["+main.Main_ServerOption.statWILL+"]","§7"+main.Main_ServerOption.statWILL+"는 플레이어의","§7크리티컬에 관여합니다.","§e["+main.Main_ServerOption.statLUK+"]","§7"+main.Main_ServerOption.statLUK+"은 크리티컬 및","§7럭키 피니시, 럭키 보너스 등","§7각종 '확률'에 관여합니다."));
	  	icon.setItemMeta(iconMeta);
