...
public class NewBie_Config
{
    public void CreateNewConfig()
	{
		...
		Icon_Meta.setDisplayName("§e§l[서버 가이드]");
		Icon_Meta.setLore(Arrays.asList("§9§l[일반 유저]",
				"§e§l/스텟",
		...
		Icon.setItemMeta(Icon_Meta);
	  	...
	  	Icon_Meta.setLore(Arrays.asList(ChatColor.GRAY+ "플러그인에는 5가지 스텟이 있습니다.",ChatColor.RED +"["+main.Main_ServerOption.STR+"]",ChatColor.GRAY+""+main.Main_ServerOption.STR+"은 플레이어의",ChatColor.GRAY+"물리적 데미지에 관여합니다.",ChatColor.GREEN +  "["+main.Main_ServerOption.DEX+"]",ChatColor.GRAY+""+main.Main_ServerOption.DEX+"는 플레이어의 밸런스 및",ChatColor.GRAY+"생산 성공률과 생산 품질,",ChatColor.GRAY+"원거리 데미지에 관여합니다.",ChatColor.BLUE+"["+main.Main_ServerOption.INT+"]",ChatColor.GRAY+""+main.Main_ServerOption.INT+"은 마법방어 및 마법보호,",ChatColor.GRAY+"마법 공격력에 관여합니다.",ChatColor.WHITE+"["+main.Main_ServerOption.WILL+"]",ChatColor.GRAY + ""+main.Main_ServerOption.WILL+"는 플레이어의",ChatColor.GRAY + "크리티컬에 관여합니다.",ChatColor.YELLOW + "["+main.Main_ServerOption.LUK+"]",ChatColor.GRAY + ""+main.Main_ServerOption.LUK+"은 크리티컬 및",ChatColor.GRAY +"럭키 피니시, 럭키 보너스 등",ChatColor.GRAY +"각종 '확률'에 관여합니다."));
	  	Icon.setItemMeta(Icon_Meta);
