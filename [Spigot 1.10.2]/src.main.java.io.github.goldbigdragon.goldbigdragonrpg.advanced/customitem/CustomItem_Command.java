...
public class CustomItem_Command
{
	...
	public void HelpMessage(Player player)
	{
		...
		player.sendMessage("§b/아이템 설명추가 "+main.Main_ServerOption.damage+" : 3 ~ 6§c (아이템 장착시 "+main.Main_ServerOption.damage+" 3 ~ 6 상승)");
		player.sendMessage("§b/아이템 설명추가 방어 : 3§c (아이템 장착시 방어 3상승)");
		player.sendMessage("§a[추가 가능한 옵션 태그]");
		player.sendMessage("§b["+main.Main_ServerOption.damage+" : <숫자> ~ <숫자>] [방어 : <숫자>] [보호 : <숫자>]\n"
				+ "["+main.Main_ServerOption.magicDamage+" : <숫자> ~ <숫자>] [마법 방어 : <숫자>] [마법 보호 : <숫자>]\n"
				+ "["+main.Main_ServerOption.statSTR+" : <숫자>] ["+main.Main_ServerOption.statDEX+" : <숫자>] ["+main.Main_ServerOption.statINT+" : <숫자>] ["+main.Main_ServerOption.statWILL+" : <숫자>] ["+main.Main_ServerOption.statLUK+" : <숫자>]\n"
