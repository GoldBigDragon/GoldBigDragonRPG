...
public class CustomItem_Command
{
	...
	public void HelpMessage(Player player)
	{
		...
		player.sendMessage(ChatColor.AQUA + "/아이템 설명추가 "+main.Main_ServerOption.Damage+" : 3 ~ 6" + ChatColor.RED +" (아이템 장착시 "+main.Main_ServerOption.Damage+" 3 ~ 6 상승)");
		...
		player.sendMessage(ChatColor.AQUA + "["+main.Main_ServerOption.Damage+" : <숫자> ~ <숫자>] [방어 : <숫자>] [보호 : <숫자>]\n"
				+ "["+main.Main_ServerOption.MagicDamage+" : <숫자> ~ <숫자>] [마법 방어 : <숫자>] [마법 보호 : <숫자>]\n"
				+ "["+main.Main_ServerOption.STR+" : <숫자>] ["+main.Main_ServerOption.DEX+" : <숫자>] ["+main.Main_ServerOption.INT+" : <숫자>] ["+main.Main_ServerOption.WILL+" : <숫자>] ["+main.Main_ServerOption.LUK+" : <숫자>]\n"
