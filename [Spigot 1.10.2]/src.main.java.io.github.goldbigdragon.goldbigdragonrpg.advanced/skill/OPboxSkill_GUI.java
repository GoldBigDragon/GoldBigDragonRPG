...
public class OPboxSkill_GUI extends Util_GUI
{
	...
	public void IndividualSkillOptionGUI(Player player, short page, String SkillName)
	{
		...
		for(int count = page*45; count < b.size();count++)
		{
			...
			if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusSTR")<0)
				lore = lore + "§c승급시 보너스 "+Main_ServerOption.statSTR+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusSTR")+"%enter%";
			else if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusSTR")>0)
				lore = lore + "§b승급시 보너스 "+Main_ServerOption.statSTR+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusSTR")+"%enter%";

			if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusDEX")<0)
				lore = lore + "§c승급시 보너스 "+Main_ServerOption.statDEX+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusDEX")+"%enter%";
			else if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusDEX")>0)
				lore = lore + "§b승급시 보너스 "+Main_ServerOption.statDEX+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusDEX")+"%enter%";
				
			if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusINT")<0)
				lore = lore + "§c승급시 보너스 "+Main_ServerOption.statINT+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusINT")+"%enter%";
			else if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusINT")>0)
				lore = lore + "§b승급시 보너스 "+Main_ServerOption.statINT+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusINT")+"%enter%";

			if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusWILL")<0)
				lore = lore + "§c승급시 보너스 "+Main_ServerOption.statWILL+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusWILL")+"%enter%";
			else if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusWILL")>0)
				lore = lore + "§b승급시 보너스 "+Main_ServerOption.statWILL+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusWILL")+"%enter%";

			if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusLUK")<0)
				lore = lore + "§c승급시 보너스 "+Main_ServerOption.statLUK+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusLUK")+"%enter%";
			else if(SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusLUK")>0)
				lore = lore + "§b승급시 보너스 "+Main_ServerOption.statLUK+" : "+SkillList.getInt(SkillName+".SkillRank."+(count+1)+".BonusLUK")+"%enter%";
	...
	public void SkillRankOptionGUI(Player player, String SkillName, short SkillLevel)
	{
		...
		if(Bukkit.getPluginManager().isPluginEnabled("MagicSpells") == true)
		{
			...
			if(IncreaseDamage.equals("없음"))
				...
				Stack2("§f§l[스킬 공격력 상승]", 267,0,1,Arrays.asList("","§f[  "+IncreaseDamage+"  ]","§c["+Main_ServerOption.statSTR+"에 비례하여 대미지 상승]","","§e[좌 클릭시 영향 주는 스텟 변경]"), 21, inv);
			else if(IncreaseDamage.equals(Main_ServerOption.statDEX))
				Stack2("§f§l[스킬 공격력 상승]", 261,0,1,Arrays.asList("","§f[  "+IncreaseDamage+"  ]","§c["+Main_ServerOption.statDEX+"에 비례하여 대미지 상승]","","§e[좌 클릭시 영향 주는 스텟 변경]"), 21, inv);
			else if(IncreaseDamage.equals(Main_ServerOption.statINT))
				Stack2("§f§l[스킬 공격력 상승]", 369,0,1,Arrays.asList("","§f[  "+IncreaseDamage+"  ]","§c["+Main_ServerOption.statINT+"에 비례하여 대미지 상승]","","§e[좌 클릭시 영향 주는 스텟 변경]"), 21, inv);
			else if(IncreaseDamage.equals(Main_ServerOption.statWILL))
				Stack2("§f§l[스킬 공격력 상승]", 370,0,1,Arrays.asList("","§f[  "+IncreaseDamage+"  ]","§c["+Main_ServerOption.statWILL+"에 비례하여 대미지 상승]","","§e[좌 클릭시 영향 주는 스텟 변경]"), 21, inv);
			else if(IncreaseDamage.equals(Main_ServerOption.statLUK))
				Stack2("§f§l[스킬 공격력 상승]", 322,0,1,Arrays.asList("","§f[  "+IncreaseDamage+"  ]","§c["+Main_ServerOption.statLUK+"에 비례하여 대미지 상승]","","§e[좌 클릭시 영향 주는 스텟 변경]"), 21, inv);
			else
		...
		if(SkillLevel != 1)
		{
			...
			Stack2("§f§l[보너스 "+Main_ServerOption.statSTR+"]", 267,0,1,Arrays.asList("","§b["+SkillName+" "+(SkillLevel-1)+" 레벨에서","§b현재 레벨로 승급할 때 얻는 "+Main_ServerOption.statSTR+"]","§f     §l"+SkillList.getInt(SkillName+".SkillRank."+SkillLevel+".BonusSTR"),"","§e[좌 클릭시 보너스 스텟 변경]"), 30, inv);
			Stack2("§f§l[보너스 "+Main_ServerOption.statDEX+"]", 261,0,1,Arrays.asList("","§b["+SkillName+" "+(SkillLevel-1)+" 레벨에서","§b현재 레벨로 승급할 때 얻는 "+Main_ServerOption.statDEX+"]","§f     §l"+SkillList.getInt(SkillName+".SkillRank."+SkillLevel+".BonusDEX") ,"","§e[좌 클릭시 보너스 스텟 변경]"), 31, inv);
			Stack2("§f§l[보너스 "+Main_ServerOption.statINT+"]", 369,0,1,Arrays.asList("","§b["+SkillName+" "+(SkillLevel-1)+" 레벨에서","§b현재 레벨로 승급할 때 얻는 "+Main_ServerOption.statINT+"]","§f     §l"+SkillList.getInt(SkillName+".SkillRank."+SkillLevel+".BonusINT"),"","§e[좌 클릭시 보너스 스텟 변경]"), 32, inv);
			Stack2("§f§l[보너스 "+Main_ServerOption.statWILL+"]", 370,0,1,Arrays.asList("","§b["+SkillName+" "+(SkillLevel-1)+" 레벨에서","§b현재 레벨로 승급할 때 얻는 "+Main_ServerOption.statWILL+"]","§f     §l"+SkillList.getInt(SkillName+".SkillRank."+SkillLevel+".BonusWILL") ,"","§e[좌 클릭시 보너스 스텟 변경]"), 33, inv);
			Stack2("§f§l[보너스 "+Main_ServerOption.statLUK+"]", 322,0,1,Arrays.asList("","§b["+SkillName+" "+(SkillLevel-1)+" 레벨에서","§b현재 레벨로 승급할 때 얻는 "+Main_ServerOption.statLUK+"]","§f     §l"+SkillList.getInt(SkillName+".SkillRank."+SkillLevel+".BonusLUK") ,"","§e[좌 클릭시 보너스 스텟 변경]"), 34, inv);
	...
	public void SkillRankOptionGUIClick(InventoryClickEvent event)
	{
		...
		case 30://보너스 "+GoldBigDragon_RPG.ServerOption.STR+"
			player.sendMessage("§d[스킬] : 보너스 "+Main_ServerOption.statSTR+" 수치를 입력해 주세요!");
			u.setType(player, "Skill");
			u.setString(player, (byte)1, "BSTR");
			break;
		case 31://보너스 "+GoldBigDragon_RPG.ServerOption.DEX+"
			player.sendMessage("§d[스킬] : 보너스 "+Main_ServerOption.statDEX+" 수치를 입력해 주세요!");
			u.setType(player, "Skill");
			u.setString(player, (byte)1, "BDEX");
			break;
		case 32://보너스 "+GoldBigDragon_RPG.ServerOption.INT+"
			player.sendMessage("§d[스킬] : 보너스 "+Main_ServerOption.statINT+" 수치를 입력해 주세요!");
			u.setType(player, "Skill");
			u.setString(player, (byte)1, "BINT");
			break;
		case 33://보너스 "+GoldBigDragon_RPG.ServerOption.WILL+"
			player.sendMessage("§d[스킬] : 보너스 "+Main_ServerOption.statWILL+" 수치를 입력해 주세요!");
			u.setType(player, "Skill");
			u.setString(player, (byte)1, "BWILL");
			break;
		case 34://보너스 "+GoldBigDragon_RPG.ServerOption.LUK+"
			player.sendMessage("§d[스킬] : 보너스 "+Main_ServerOption.statLUK+" 수치를 입력해 주세요!");
			u.setType(player, "Skill");
