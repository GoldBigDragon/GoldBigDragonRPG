...
public class User_Object
{
	...
	{
		if(main.Main_ServerOption.economy!=null)
		{
			if(Money > 0)
				main.Main_ServerOption.economy.depositPlayer(player.getName(), Money);
			else if(Money < 0)
				main.Main_ServerOption.economy.withdrawPlayer(player.getName(), -1*Money);
		}
		else
		{
			if(Money != 0)
	...
	{
		if(main.Main_ServerOption.economy!=null)
			return (long) main.Main_ServerOption.economy.getBalance(player.getName());
		else
			return Stat_Money;
	}
	...
	public void setStat_Money(long value)
	{
		if(main.Main_ServerOption.economy!=null)
		{
			if(main.Main_ServerOption.economy.withdrawPlayer(player.getName(), main.Main_ServerOption.economy.getBalance(player.getName())).transactionSuccess())
				main.Main_ServerOption.economy.depositPlayer(player.getName(), value);
		}
		else
			Stat_Money = value;
	}
	...
	public User_Object(Player player)
	{
		...
		if(PlayerConfig.contains("Stat.STR")==false)
		{
			...
			if(main.Main_ServerOption.economy!=null)
				main.Main_ServerOption.economy.depositPlayer(player.getName(), PlayerConfig.getInt("SupportMoney"));
			else
		...
		else
		{
			...
			if(main.Main_ServerOption.economy!=null)
				Stat_Money = (long) main.Main_ServerOption.economy.getBalance(player.getName());
			else
	...
	public void saveAll()
	{
		...
		if(main.Main_ServerOption.economy!=null)
			PlayerConfig.set("Stat.Money", (long) main.Main_ServerOption.economy.getBalance(player.getName()));
		else
